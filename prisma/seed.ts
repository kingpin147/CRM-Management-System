...
import { PrismaClient, CustomerType, CustomerStatus, TicketType, TicketStatus, Role } from '@prisma/client'
...
async function main() {
  console.log('Seeding dummy data into Supabase/PostgreSQL database...')
  ...
  // 2. Create Dummy Customers with Full Solar Specs, Packages, Invoices, Ledger & Tickets
  ...
  console.log('✅ Successfully seeded dummy customers, solar systems, packages, reports, invoices, ledger entries, and tickets!')
}
